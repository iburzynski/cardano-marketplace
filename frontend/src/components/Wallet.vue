                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                  <div class="px-4 sm:px-6">
                    <div v-if="!walletAction.enable && curProvider" class="flex">
                      <img v-if="curProvider.icon" class="inline-block align-bottom w-16 h-16 mr-2"
                    ...
                    <div v-else class="pt-3">
                      <div v-for="(asset, index) in balance.multiAssets" :key="index">
                        ...
                        <div class="flex justify-between items-start">
                          <span v-if="asset.name" class="text-blue-900 text-xl font-extrabold pb-2">
                            {{ asset.name }}
                          </span>
...
export default {
  ...
  methods: {
    ...
    async sellNft(providerInstance: CIP30Instance, asset) {
