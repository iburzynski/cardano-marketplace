        ...
        <div class="relative flex h-24 items-center justify-between">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex items-center">
              <img class="block h-12 w-auto lg:hidden" src="../assets/ea_logo.png" alt="EMURGO Academy">
              <img class="hidden h-18 w-auto lg:block" src="../assets/ea_logo.png" alt="EMURGO Academy">
            </div>
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex h-24 space-x-4 items-center text-gray-300 font-medium text-xs lg:text-base">
                <h1 class="text-red-400 font-semibold lg:text-2xl text-lg">CNFT Marketplace</h1>
                <a target="_blank" rel="noreferrer noopener"
                  :href="'https://testnet.cardanoscan.io/address/'+market.address"
                  class="hover:bg-red-400 hover:text-white block px-3 py-2 rounded-md">
